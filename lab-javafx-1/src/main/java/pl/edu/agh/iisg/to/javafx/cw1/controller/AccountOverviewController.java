...
public class AccountOverviewController {
    ...
    @FXML
    private TableColumn<Transaction, LocalDate> dateColumn= new TableColumn<>();

    @FXML
    private TableColumn<Transaction, String> payeeColumn = new TableColumn<Transaction, String>();

    @FXML
    private TableColumn<Transaction, Category> categoryColumn =new TableColumn<Transaction, Category>();

    @FXML
    private TableColumn<Transaction, BigInteger> inflowColumn = new TableColumn<Transaction, BigInteger>();
